...
#pragma endregion
	...
	QJsonArray jsArr_materialsTemp;
	jsArr_materialsTemp = m_rootObj["materials"].toArray();

	QJsonArray jsArr_materials;
	QJsonArray jsArr_materials2;
	QJsonArray jsArr_materials3_1;

	for (int i =0 ; i < jsArr_materialsTemp.size(); i++)
	{
...
#pragma region step3
		...
		QJsonObject jsonObject2 =
			((((m_rootObj["materials"]).toArray())[i].toObject())["extensions"].toObject())["KHR_technique_webgl"].toObject();   //Create   "KHR_techniques_webgl"-value

		jsArr_materials2 = m_rootObj["materials"].toArray();
		jsObj_materials2 = jsArr_materials2[i].toObject();
		...
		jsArr_materials2[i] = jsObj_materials2;
...
#pragma region step3.1
		...
		jsObj_materials3_1 = jsArr_materials3_1[i].toObject();
		...
		int jsObj_mat_ext_KHRs3_1_tec_temp = jsObj_mat_ext_KHRs3_1["technique"].toInt();

		QJsonObject jsObj_ext_KHRs_tec =
			(((m_rootObj["extensions"].toObject())["KHR_techniques_webgl"].toObject())["techniques"].toArray())[jsObj_mat_ext_KHRs3_1_tec_temp].toObject();
		...
		jsArr_materials3_1[i] = jsObj_materials3_1;
...
#pragma region step4
	...
	for (int k = 0 ; k < (((m_rootObj["extensions"].toObject())["KHR_techniques_webgl"].toObject())["techniques"].toArray()).size(); k++)
	{
		...
		jsObj_ext_KHRs_tec4 = jsonArray_ext_KHRs_tec4[k].toObject();

		QJsonObject jsObj_ext_KHRs_tec_par_temp4 =              //= 右值 准备工作
			((((m_rootObj["extensions"].toObject())["KHR_techniques_webgl"].toObject())["techniques"].toArray())[k].toObject())["parameters"].toObject();
		...
		jsonArray_ext_KHRs_tec4[k] = jsObj_ext_KHRs_tec4;
